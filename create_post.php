	        	...
	        	<div class="dropdown">
	        		<a href="javascript:void(0)" class="badge badge-pill badge-secondary text-white dropdown-toggle " id="type-selected" data-toggle="dropdown">
	        			<?php if(isset($type) && $type == 1): ?>
	        				<i class="fa fa-lock"></i> Riêng tư
        				<?php else: ?>
	        			<i class="fa fa-globe-asia"></i> Công khai
        				<?php endif; ?>
	        		</a>
	        		<div class="dropdown-menu">
	        			 <a class="dropdown-item type-item" href="javascript:void(0)" data-type="0"><i class="fa fa-globe-asia"></i> Riêng tư</a>
	        			 <a class="dropdown-item type-item" href="javascript:void(0)" data-type="1"><i class="fa fa-lock"></i> Công khai</a>
	        		</div>
	        	</div>
	        </div>
		</div>
