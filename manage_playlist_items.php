...
<div class="container-fluid">
	...
	<input type="hidden" name="playlist_id" value="<?php echo $_GET['pid'] ?>">
		<div class="row">
			...
			<label for="" class="control-label">Tìm bài hát</label>
				<div class="position-relative w-100">
					<input type="search" class="form-control form-control-sm w-100" id="msearch" placeholder="Điền tên bài hát hoặc nghệ sĩ" autocomplete="off">
...
<div id="list_clone" class="d-none">
	...
	<div id="pdet" class="d-flex justify-content-between align-items-center">
		<div class="d-flex">
			...
			<div class="ml-2 mr-4">
				<div><b><large class="mtitle">Tên</large></b>
				</div>
				<div>
					<b><small class="martist">Nghệ sĩ</small></b>
					</div>
				</div>
			</div>
		</span>
...
<script>
	$('#manage_playlist_items').submit(function(e){
		...
		if($('#plist tbody tr').length <= 0){
			alert_toast("Bạn phải thêm ít nhất 1 bài hát",'warning')
			return false;
		}
		$.ajax({
