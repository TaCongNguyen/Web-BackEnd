	...
	<div class="d-flex justify-content-between align-items-center w-100">
		<div class="form-group" style="width:calc(50%) ">
			<div class="input-group">
              <input type="search" id="filter" class="form-control form-control-sm" placeholder="Tìm kiếm bài hát">
		...
		<button class="btn btn-sm btn-primary bg-gradient-primary" type="button" id="manage_genre"><i class="fa fa-plus"></i> Thêm mới</button>
		<?php endif; ?>
	</div>
