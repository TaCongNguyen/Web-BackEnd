<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-primary navbar-dark bg-dark border-primary">
    ...
    <?php endif; ?>
      ...
      <li>
        <a class="nav-link text-gradient-primary"  href="./" role="button"> <large><b>GenMusic</b></large></a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="account_settings" style="left: -2.5em;">
              <button class="dropdown-item" type="button" id="my_profile"><i class="fa fa-id-card"></i> Cá nhân</button>
              <button class="dropdown-item" type="button" id="manage_my_account"><i class="fa fa-cog"></i> Quản lí tài khoản</button>
              <button class="dropdown-item" onclick="location.href='ajax.php?action=logout'"><i class="fa fa-power-off"></i> Đăng xuất</button>
            </div>
          </li>
    </ul>
  </nav>
